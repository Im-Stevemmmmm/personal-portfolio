        ...
        <div className="flex flex-row">
          <HtmlTag name="h1">
            <h1 className="text-6xl max-w-3xl font-bold">
              Hi, <br /> I'm <span className="text-teal-300">Esteban</span>,{" "}
              <br />a <span className="text-blue-300">fullstack developer</span>
              .
            </h1>
            <h4 className="my-2 text-sm text-gray-400 font-medium">
              7 years of personal / Systems developer / Certified AWS specialist
              experience
            </h4>
          </HtmlTag>
        </div>
